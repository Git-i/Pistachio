...
namespace Pistachio {
	...
	struct SetInfo
	{
		// provide binding slot, count and type
	...
	/*
	* Material Info provides the way to use the material generated by a shader
	* every element of the "infos" vector contains a descriptor set
	* the descriptor set corresponds to the one in the shader
	* Usage:
	*	After Creating a shader, you retrieve its Material info
	*	in every one of the "infos", you have a slot, type and count. the elements of this vector are corresponding to one binding in the set
