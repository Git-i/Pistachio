...
namespace Pistachio {
	...
	public:
		...
		static Error CreateHeadlessDevice(ID3D11Device** pd3dDevice, ID3D11DeviceContext** pd3dDeviceContext, ID3D11DepthStencilView** pDSV, ID3D11RenderTargetView** pRenderTargetView);
		...
		static void CleanupRenderTarget(ID3D11RenderTargetView* pMainRenderTargetView, ID3D11DeviceContext* pd3dDeviceContext, ID3D11DepthStencilView* pDSV);
	};
}